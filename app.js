    const subjectData = {
      ...
      object: ["Object character", "one object silhouette", "object-to-character design", ["Button Bean", "Tiny — 5 min Paint Tube", "Key Charm"]],
      ...
      flower: ["Flower mascot", "one flower head or petal cluster", "petal grouping", ["Bloom Bean", "Petal Dot", "Tiny — 5 min Daisy Pal"]],
      star: ["Star / moon mascot", "one moon, star, or comet shape", "celestial silhouette", ["Moon Dot", "Starry Bean", "Tiny — 5 min Comet"]],
      potion: ["Potion bottle mascot", "one rounded bottle shape", "object clarity", ["Potion Pip", "Bottle Bop", "Tiny — 5 min Elixir"]],
      bug: ["Tiny — 5 min bug mascot", "one oval bug body", "small repeated shapes", ["Button Beetle", "Moth Dot", "Tiny — 5 min Flutter"]],
      cloud: ["Cloud / weather mascot", "one puffy cloud or weather shape", "soft edges", ["Cloud Puff", "Rainy Bean", "Storm Dot"]],
      gem: ["Gem / charm mascot", "one diamond or charm shape", "faceted simplicity", ["Gem Sprite", "Crystal Dot", "Tiny — 5 min Relic"]],
      ...
      ghost: ["Ghost mascot", "one soft ghost sheet shape", "soft spooky silhouette", ["Ghost Bean", "Sheet Sprite", "Tiny — 5 min Boo Buddy"]],
      creature: ["Tiny — 5 min creature mascot", "one simple creature body", "invented creature design", ["Pocket Gremlin", "Nub Creature", "Soft Monster Dot"]],
      ...
      shell: ["Shell mascot", "one shell or beach trinket shape", "soft beach object design", ["Shell Bean", "Pearl Dot", "Tiny — 5 min Conch"]],
      aquatic: ["Aquatic mascot", "one fish, droplet, or sea-creature shape", "water-soft silhouette", ["Bubble Fish", "Droplet Dot", "Tiny — 5 min Jelly"]],
      robot: ["Tiny — 5 min robot mascot", "one rounded mechanical body", "cute machine design", ["Bolt Bean", "Robo Dot", "Tiny — 5 min Circuit"]],
      device: ["Device mascot", "one phone, tablet, or tiny screen shape", "tech object character", ["Pixel Pal", "Tiny — 5 min Tablet", "Screen Bean"]],
      clothing: ["Clothing mascot", "one clothing item silhouette", "soft fabric character", ["Sock Gremlin", "Mittens Dot", "Tiny — 5 min Hoodie"]],
      accessory: ["Accessory mascot", "one wearable accessory shape", "fashion object personality", ["Bow Bean", "Charm Clip", "Tiny — 5 min Locket"]],
      music: ["Music mascot", "one musical object or note shape", "sound-symbol character", ["Note Dot", "Tiny — 5 min Tambourine", "Chord Bean"]],
      ...
      tinyMonster: ["Tiny — 5 min monster mascot", "one small monster body", "soft creature attitude", ["Fang Puff", "Nub Goblin", "Tiny — 5 min Howl"]],
      zodiac: ["Zodiac mascot", "one zodiac-symbol-inspired body", "symbolic character design", ["Aries Puff", "Moon Sign Dot", "Star Chart Bean"]],
      emoji: ["Emoji mascot", "one simple expression-ball body", "face-first character design", ["Mood Dot", "Emoji Bean", "Tiny — 5 min Reaction"]],
      package: ["Package mascot", "one box, mailer, or wrapped shape", "parcel character design", ["Parcel Pip", "Box Bean", "Tiny — 5 min Mailer"]],
      furniture: ["Furniture mascot", "one furniture silhouette", "home object character", ["Chair Dot", "Lampy Bean", "Tiny — 5 min Table"]],
    ...
    const emotions = {
      ...
      angryTiny: ["tiny-angry", "tiny angry brows, dot eyes, very small frown", "soft round body", "Tiny — 5 min-angry works best on plush shapes."],
    ...
    const lessonSizes = {
      micro: ["Micro: 5 minute warm-up", [["One big shape", "Draw only the body shape.", "No details yet."], ["Low face", "Add two eyes below center and one mouth.", "High faces feel less cute."], ["Tiny — 5 min finish", "Add one limb pair or one twist.", "Stop small."]]],
      tiny: ["Tiny: 10 minute sketch", [["Block shape", "Draw one readable base shape.", "Do not scratch over lines."], ["Place face", "Eyes below center, mouth close under.", "Face placement matters."], ["Tiny — 5 min limbs", "Use simple curves or ovals.", "Keep limbs small."], ["Color", "Flat color, one shadow, one highlight.", "Do not over-render."]]],
      normal: ["Normal — 15 min: beginner lesson", [["Ghost shape", "Lightly draw the base like a sticker silhouette.", "Avoid details early."], ["Center guide", "Add vertical guide and low face line.", "Guides are not cheating."], ["Eyes first", "Place eyes before the mouth.", "Eye spacing changes personality."], ["Mouth test", "Try three mouths, choose one.", "Do not marry the first mouth."], ["Limbs", "Add tiny arms or feet.", "Keep them secondary."], ["Clean line", "Lower sketch opacity and redraw.", "Undo messy strokes."], ["Color pass", "Base color, one shadow, one highlight.", "Stop early."]]],
      ...
      oneShape: ["One-shape-only drill", [["Choose shape", "Use one body shape only.", "No combined forms."], ["Alive face", "Low face and one mouth.", "No limbs yet."], ["Tiny — 5 min limbs", "Two curves or two ovals.", "Keep small."], ["One mark", "Sparkle, stitch, blush, patch.", "One mark only."]]],
    ...
    const twists = {
      ...
      hat: ["Tiny — 5 min hat", "a tiny hat", "Add a tiny hat; do not cover the face.", '<path class="feature" d="M220 130 L300 130 L285 95 L235 95 Z M210 132 L310 132"></path>'],
      ...
      bow: ["Tiny — 5 min bow", "a tiny bow", "Add a bow on one side.", '<path class="feature" d="M198 135 L230 155 L198 175 Z M262 135 L230 155 L262 175 Z"></path>'],
      halo: ["Soft halo", "a soft halo", "Float a halo above the mascot.", '<ellipse class="feature" cx="260" cy="92" rx="58" ry="16"></ellipse>'],
      fang: ["Tiny — 5 min fang", "a tiny fang", "Add one tiny fang.", '<path class="feature" d="M263 315 L270 332 L277 315"></path>'],
      ...
      leaf: ["Tiny — 5 min leaf", "a tiny leaf", "Add one leaf sprout.", '<path class="feature" d="M260 132 C260 102 292 94 312 112 C288 118 272 128 260 132 Z"></path>'],
      ...
      teardrop: ["Tiny — 5 min teardrop", "a tiny teardrop", "Add one teardrop.", '<path class="feature" d="M320 278 C335 295 335 312 320 318 C305 312 305 295 320 278 Z"></path>'],
      bandage: ["Tiny — 5 min bandage", "a tiny bandage", "Add a small bandage.", '<rect class="feature" x="330" y="285" width="55" height="24" rx="10"></rect><path class="feature" d="M350 292 L365 307 M365 292 L350 307"></path>'],
      crown: ["Tiny — 5 min crown", "a tiny crown", "Add a three-point crown.", '<path class="feature" d="M220 135 L240 100 L260 135 L280 100 L300 135 Z"></path>'],
      ...
      scarf: ["Tiny — 5 min scarf", "a tiny scarf", "Add a scarf band.", '<path class="feature" d="M195 338 L325 338 M285 338 L330 380"></path>'],
      ...
      zipper: ["Tiny — 5 min zipper", "a tiny zipper", "Add a short zipper line on one side.", '<path class="feature" d="M350 220 L350 315 M340 235 L360 235 M340 255 L360 255 M340 275 L360 275 M340 295 L360 295"></path>'],
      ...
      tinyBoots: ["Tiny — 5 min boots", "tiny boots", "Add two tiny boot shapes at the bottom.", '<path class="feature" d="M175 420 L220 420 L220 445 L165 445 Z M300 420 L345 420 L355 445 L300 445 Z"></path>'],
      ...
      tinyBackpack: ["Tiny — 5 min backpack", "a tiny backpack", "Add a small backpack shape behind one side.", '<path class="feature" d="M145 230 L95 250 L95 350 L145 365"></path><path class="feature" d="M105 270 L135 270"></path>'],
      ...
      tinySatchel: ["Tiny — 5 min satchel", "a tiny satchel", "Add a little side bag.", '<path class="feature" d="M370 320 L425 325 L420 385 L365 380 Z M380 320 C385 290 410 292 415 325"></path>']
    ...
    const backdropStyleMap = {
      none: ["None", "No backdrop. Keep the mascot as a clean sticker subject."],
      softShadow: ["Soft shadow", "A small grounding oval under the mascot."],
      glowHalo: ["Glow halo", "A soft circle or aura behind the body."],
      stickerBurst: ["Sticker burst", "A simple burst frame behind the mascot."],
      cloudPuff: ["Cloud puff", "A few soft puffs under or behind the mascot."],
      floatingStars: ["Floating stars", "Tiny stars or sparkles around the mascot."],
      tinyProps: ["Tiny props", "One or two tiny props near the mascot, never a full scene."],
      moonGlow: ["Moon glow", "A moon-like glow or crescent framing shape."],
      candyConfetti: ["Candy confetti", "Small dots, sprinkles, or candy marks."],
      storybookArch: ["Storybook arch", "A simple rounded arch frame."],
      paintBlob: ["Paint blob", "A soft abstract paint shape behind the mascot."],
      polaroidFrame: ["Polaroid frame", "A simple square photo-card frame."]
    };

    const backdropDensityMap = {
      minimal: ["Minimal", "One grounding cue only."],
      soft: ["Soft", "One grounding cue plus two to four tiny atmosphere marks."],
      decorated: ["Decorated", "A frame or atmosphere cluster, still low detail."]
    };

    function pickAutoBackdrop({ moodDrift = "dreamy", subjectType = "blob", mascotEnergy = "calmBean" } = {}) {
      if (moodDrift === "eerie") return "moonGlow";
      if (moodDrift === "glittery") return "floatingStars";
      if (moodDrift === "chaotic") return "stickerBurst";
      if (moodDrift === "floating") return "glowHalo";
      if (moodDrift === "cozy" || mascotEnergy === "sleepyBaby") return "softShadow";
      if (subjectType === "cloud") return "cloudPuff";
      if (subjectType === "food") return "candyConfetti";
      return "softShadow";
    }

    function getBackdropPlan({ backdropStyle = "auto", backdropDensity = "soft", moodDrift = "dreamy", subjectType = "blob", mascotEnergy = "calmBean" } = {}) {
      const styleKey = backdropStyle === "auto"
        ? pickAutoBackdrop({ moodDrift, subjectType, mascotEnergy })
        : (backdropStyle || "none");
      const style = backdropStyleMap[styleKey] || backdropStyleMap.none;
      const density = backdropDensityMap[backdropDensity] || backdropDensityMap.soft;

      const instructionMap = {
        none: "Leave the background blank or transparent.",
        softShadow: "Draw a soft oval under the mascot, lighter than the main character shadow.",
        glowHalo: "Place one soft halo behind the mascot, not over the face.",
        stickerBurst: "Use a simple burst or badge shape behind the body. Keep points away from the face silhouette.",
        cloudPuff: "Use two or three puffs as a base. Do not turn it into a full sky scene.",
        floatingStars: "Place tiny stars outside the silhouette. Keep them fewer than the face details.",
        tinyProps: "Use one or two props only, parked low or off to the side.",
        moonGlow: "Use one crescent, circle glow, or misty oval. Avoid black heavy fog.",
        candyConfetti: "Use tiny sprinkles around the outside edge, not across the character.",
        storybookArch: "Draw a soft arch behind the mascot like a frame.",
        paintBlob: "Put one abstract blob behind the body with low contrast.",
        polaroidFrame: "Use a simple photo-card frame with the mascot centered."
      };

      return {
        styleKey,
        densityKey: backdropDensity,
        label: style[0],
        densityLabel: density[0],
        concept: style[1],
        densityRule: density[1],
        instruction: instructionMap[styleKey] || "Keep the backdrop simple and secondary.",
        warning: "No perspective rooms, landscapes, furniture scenes, or high-detail environments. The mascot stays readable first.",
        iconRule: "Backdrop must be lighter, softer, or simpler than the mascot so it does not flatten the silhouette."
      };
    }


    const shapeBaseMap = {
      blob: ["Blob", "soft rounded mascot silhouette"],
      circle: ["Circle", "simple circular mascot base"],
      oval: ["Oval", "gentle stretched mascot form"],
      bean: ["Bean", "bean-like asymmetrical shape"],
      squircle: ["Squircle", "soft square-circle hybrid"],
      triangle: ["Triangle", "pointed mascot silhouette"],
      diamond: ["Diamond", "angled diamond structure"],
      crescent: ["Crescent", "moon-like curved silhouette"],
      capsule: ["Capsule", "pill capsule mascot body"],
      arch: ["Arch", "arched top-heavy mascot"],
      droplet: ["Droplet", "teardrop liquid silhouette"],
      starburst: ["Starburst", "spiky energetic silhouette"],
      stackedPebbles: ["Stacked Pebbles", "stacked rounded forms"],
      ribbonLoop: ["Ribbon Loop", "looping ribbon silhouette"],
      tallBottle: ["Tall Bottle", "tall container silhouette"],
      wideBadge: ["Wide Badge", "wide sticker-badge body"],
      cloudCluster: ["Cloud Cluster", "multi-puff cloud silhouette"]
    };

    const bodyBuildMap = {
      singleBlob: ["Single Soft Blob", "one continuous soft body shape"],
      stackedShapes: ["Stacked Shapes", "build from layered simple forms"],
      containerShape: ["Container Shape", "cup, bottle, can, or jar construction"],
      foldedPaper: ["Folded Paper", "paper-cut folded structure"],
      wrappedCandy: ["Wrapped Candy", "center mass with side wrapping"],
      puffyCluster: ["Puffy Cluster", "multiple soft connected puffs"],
      symmetricalMask: ["Symmetrical Mask", "mirrored centered construction"],
      iconBadge: ["Icon Badge", "simple readable icon silhouette"],
      hangingCharm: ["Hanging Charm", "small dangling mascot construction"]
    };

const moodDriftMap = {
      dreamy: ["Dreamy", "soft floating dreamy atmosphere"],
      eerie: ["Eerie", "quiet eerie drifting mood"],
      glittery: ["Glittery", "sparkly glossy drifting energy"],
      tender: ["Tender", "gentle emotional softness"],
      chaotic: ["Chaotic", "chaotic cute energy"],
      floating: ["Floating", "light floating magical motion"],
      sleepy: ["Sleepy", "slow sleepy drifting atmosphere"],
      cozy: ["Cozy", "warm cozy plush energy"]
    };

    const mascotEnergyMap = {
      calmBean: ["Calm Bean", "soft rounded calming mascot"],
      loudGremlin: ["Loud Gremlin", "chaotic loud creature energy"],
      sleepyBaby: ["Sleepy Baby", "sleepy tiny mascot energy"],
      tinyVillain: ["Tiny — 5 min Villain", "tiny dramatic villain energy"],
      pocketHero: ["Pocket Hero", "heroic tiny mascot posture"],
      hauntedPlush: ["Haunted Plush", "slightly spooky plush energy"],
      arcadeBuddy: ["Arcade Buddy", "bright arcade sticker energy"],
      softRoyalty: ["Soft Royalty", "soft regal mascot energy"]
    };
    ...
    const extraTwists = {
      tinyEarring: ["Tiny — 5 min earring", "a tiny earring", "Hang one small ring or bead from the side.", '<circle class="feature" cx="392" cy="285" r="12"></circle><circle class="feature" cx="392" cy="285" r="5"></circle>'],
      ...
      tinyKey: ["Tiny — 5 min key", "a tiny key", "Hang a small key charm from one side.", '<circle class="feature" cx="390" cy="365" r="12"></circle><path class="feature" d="M390 377 L390 425 M390 410 L410 410 M390 425 L405 425"></path>'],
      ...
      tinyEnvelope: ["Tiny — 5 min envelope", "a tiny envelope", "Add a small envelope patch.", '<rect class="feature" x="330" y="315" width="58" height="38" rx="6"></rect><path class="feature" d="M330 318 L359 344 L388 318"></path>'],
      ...
      tinyLace: ["Tiny — 5 min lace edge", "a tiny lace edge", "Add a scalloped lace strip along one edge.", '<path class="feature" d="M150 250 Q162 270 174 250 Q186 270 198 250 Q210 270 222 250"></path>'],
      ...
      tinyUmbrella: ["Tiny — 5 min umbrella", "a tiny umbrella", "Add a little umbrella cap above one side.", '<path class="feature" d="M335 160 Q385 115 435 160 Z"></path><path class="feature" d="M385 160 L385 230 Q385 245 400 240"></path>'],
      ...
      tinyNameTag: ["Tiny — 5 min name tag", "a tiny name tag", "Add a small rounded name tag.", '<rect class="feature" x="330" y="345" width="70" height="34" rx="12"></rect><path class="feature" d="M348 362 L382 362"></path>'],
      ...
      tinyPocket: ["Tiny — 5 min pocket", "a tiny pocket", "Add a small pocket patch.", '<path class="feature" d="M330 305 L390 305 L382 355 Q360 370 338 355 Z"></path>'],
      ...
      tinyPawPrint: ["Tiny — 5 min paw print", "a tiny paw print", "Add one tiny paw-print patch.", '<circle class="solid" cx="358" cy="320" r="7"></circle><circle class="solid" cx="344" cy="304" r="4"></circle><circle class="solid" cx="358" cy="298" r="4"></circle><circle class="solid" cx="372" cy="304" r="4"></circle>'],
      ...
      tinyLantern: ["Tiny — 5 min lantern", "a tiny lantern", "Hang a little lantern from one side.", '<path class="feature" d="M385 320 Q410 340 405 365"></path><rect class="feature" x="382" y="365" width="44" height="54" rx="12"></rect><path class="feature" d="M392 378 L416 378 M392 405 L416 405"></path>'],
      ...
      tinyBook: ["Tiny — 5 min book", "a tiny book", "Add a tiny open-book charm.", '<path class="feature" d="M330 335 Q360 318 390 335 L390 385 Q360 370 330 385 Z"></path><line class="feature" x1="360" y1="325" x2="360" y2="375"></line>'],
      ...
      tinyTeacup: ["Tiny — 5 min teacup", "a tiny teacup", "Add a little teacup charm.", '<path class="feature" d="M340 335 L392 335 L386 380 Q366 392 346 380 Z"></path><path class="feature" d="M392 348 Q420 350 405 372"></path>'],
      ...
      tinyFlag: ["Tiny — 5 min flag", "a tiny flag", "Add a tiny flag on a short pole.", '<line class="feature" x1="355" y1="125" x2="355" y2="210"></line><path class="feature" d="M355 130 L420 145 L355 165 Z"></path>'],
      ...
      tinyBandana: ["Tiny — 5 min bandana", "a tiny bandana", "Add a small bandana triangle.", '<path class="feature" d="M195 340 L325 340 L260 405 Z"></path><path class="feature" d="M230 340 L220 370 M290 340 L300 370"></path>'],
      ...
      tinyCompass: ["Tiny — 5 min compass", "a tiny compass", "Add a small compass charm.", '<circle class="feature" cx="365" cy="325" r="28"></circle><path class="feature" d="M365 300 L375 325 L365 350 L355 325 Z"></path>'],
      ...
      tinyCandle: ["Tiny — 5 min candle", "a tiny candle", "Add one tiny candle detail.", '<rect class="feature" x="350" y="305" width="26" height="62" rx="8"></rect><path class="feature" d="M363 295 C350 280 366 265 368 248 C388 272 382 292 363 295 Z"></path>'],
      ...
      paintSplatter: ["Tiny — 5 min paint splatter", "tiny paint splatter", "Add a few tiny paint drops.", '<circle class="solid" cx="360" cy="210" r="7"></circle><circle class="solid" cx="385" cy="225" r="4"></circle><circle class="solid" cx="345" cy="235" r="4"></circle><circle class="solid" cx="372" cy="245" r="3"></circle>'],
    ...
    const styleRecipes = [
      ...
      "Tiny — 5 min app icon: big silhouette, simple face, no tiny details.",
    ...
    const praises = ["Messy first sketch allowed. Clean line comes later.", "Readable beats perfect.", "Move the face lower before redrawing everything.", "Tiny — 5 min arms are powerful. Avoid noodle chaos.", "Stop after one shadow. Future you can over-render later."];
    ...
    function bootSelects() {
      ...
      populateSelect("surpriseType", mascotEnergyMap, "calmBean");
      populateSelect("moodDrift", moodDriftMap, "dreamy");
      populateSelect("shapeBase", shapeBaseMap, "blob");
      populateSelect("bodyBuild", bodyBuildMap, "singleBlob");
      populateSelect("backdropStyle", Object.assign({ auto: ["Auto", "Choose from mood and subject."] }, backdropStyleMap), "auto");
      populateSelect("backdropDensity", backdropDensityMap, "soft");
    ...
    function getEmotionBlueprintGuide(emotion) {
      const guides = {
        ...
        angryTiny: {
          ...
          label: "Tiny — 5 min-angry guide: angry brows, very small frown, keep the round cute body."
        },
        sadHopeful: {
    ...
    function generateImagePrompt() {
      ...
      const prompt = [
        ...
        `Tiny — 5 min twist/accessory: ${data.twistName || ctx.twistSetName || ctx.twist?.[0] || "one small charming detail"}.`,
    ...
    const APP_CACHE_NAME = "mascot-spark-v54";
...
<section><h2>Reflection</h2><div class="reflection"></div></section>
    ...
    function getCurrentShadeContext() {
      ...
      return {
        ...
        intensity: shadeIntensities[document.getElementById("shadeIntensity")?.value || "tinyShade"] || "Tiny — 5 min Shade",
    ...
    function renderShadeContext() {
      ...
      if (!box) return;
      const logicPlan = getCurrentShadeLogicPlan();
      box.innerHTML = `
        <span>Subject: ${c.subject[0]}</span>
        <span>Emotion: ${c.emotion[0]}</span>
        <span>Palette: ${c.palette.label || "Auto"}</span>
        ...
        <span>Logic light: ${logicPlan.lighting.label}</span>
        <span>Material: ${logicPlan.material.label}</span>
        <span>Shadow: ${logicPlan.strength.label}</span>
      `;
    }
    ...
    function shadingLabFallback() {
      ...
      const logicPlan = getCurrentShadeLogicPlan();
      const summary = `Use ${c.shadeStyle.toLowerCase()} with light from ${c.lightDirection.toLowerCase()}. This is a local smart SVG map, not AI image generation. It now uses ${subjectProfile.label} logic plus ${logicPlan.material.label} material logic and ${logicPlan.lighting.label} lighting logic.`;
...
,
    ...
    const lightingTypeMap = {
      ...
      stickerGloss: {
        ...
        castShadowDirection: "Tiny — 5 min offset shadow behind the sticker.",
    ...
    const shapeShadowRules = {
      ...
      food: {
        ...
        iconWarning: "Tiny — 5 min sprinkles and texture vanish quickly; enlarge one food cue."
      },
      object: {
    ...
    const materialRecipeMap = {
      auto: {
        ...
        layerMode: "Normal — 15 min or Multiply at low opacity.",
      ...
      plush: {
        ...
        texturePass: "Tiny — 5 min fabric fuzz on a separate low-opacity layer.",
      ...
      frosting: {
        ...
        texturePass: "Tiny — 5 min sprinkle texture only if readable.",
      ...
      chalky: {
        ...
        layerMode: "Multiply or Normal — 15 min low opacity.",
      ...
      crayon: {
        ...
        layerMode: "Normal — 15 min low opacity; avoid too many blend modes.",
    ...
    const limbShadowRules = {
      ...
      nubArms: { contactShadow: "Body shadow only unless arms touch the ground.", limbShadow: "Tiny — 5 min underside stroke on each nub arm.", warning: "Do not darken arms more than the face." },
      ...
      bubbleFeet: { contactShadow: "Tiny — 5 min transparent oval under each bubble foot.", limbShadow: "Inner lower crescent and tiny highlight.", warning: "Bubble feet need highlights more than heavy shadows." },
      ...
      cometTrailLegs: { contactShadow: "Soft trailing shadow behind the motion direction.", limbShadow: "Tiny — 5 min shadow at trail base.", warning: "Motion trails vanish if too thin at icon size." },
    ...
    const procreateLayerStackMap = {
      ...
      glossyIcon: [
        ...
        "Bold lower shadow.",
        "Gloss highlight.",
        "Tiny — 5 min icon-size cleanup layer."
      ],
      strangeGlam: [
        "Guide layer.",
        "Clean silhouette.",
    ...
    function getCurrentShadeLogicPlan() {
      const subjectType = document.getElementById("lessonType")?.value || currentLessonData?.type || "blob";
      const subject = subjectData[subjectType] || subjectData.blob;
      const emotion = document.getElementById("emotion")?.value || currentLessonData?.emotion || "happy";
      const limbStyle = document.getElementById("limbStyle")?.value || currentLessonData?.limbStyle || "none";
      const lightingType = document.getElementById("lightingType")?.value || "topLeft";
      const materialFeel = document.getElementById("materialFeel")?.value || "plush";
      const shadowStrength = document.getElementById("shadowStrength")?.value || "soft";
      const shadingGoal = document.getElementById("shadingGoal")?.value || "beginnerSimple";

      return generateLightingShadowPlan({
        subjectType,
    ...
    function renderShadeLogicStudio(plan = getCurrentShadeLogicPlan()) {
      renderLightingPlanCard(plan);
      renderShadowMapCard(plan);
      renderMaterialRecipeCard(plan);
      renderLayerStackCard(plan);
      renderSmallIconWarningCard(plan);
      return plan;
    }
...
function generalLessonFallback() {
    ...
    function newLesson(openBlueprint = false) {
      ...
      const shapeBase = document.getElementById("shapeBase")?.value || "blob";
      const bodyBuild = document.getElementById("bodyBuild")?.value || "singleBlob";
      const moodDrift = document.getElementById("moodDrift")?.value || "dreamy";
      const mascotEnergy = document.getElementById("surpriseType")?.value || "calmBean";
      const backdropStyle = document.getElementById("backdropStyle")?.value || "auto";
      const backdropDensity = document.getElementById("backdropDensity")?.value || "soft";
      const backdropPlan = getBackdropPlan({ backdropStyle, backdropDensity, moodDrift, subjectType: type, mascotEnergy });
      ...
      phases.splice(Math.min(5, phases.length), 0, [
        ...
        "Do not stack every accessory in the same corner. Tiny — 5 min details need breathing room."
      ]);
      ...
      phases.splice(Math.min(4, phases.length), 0, [
        `Shape base: ${shapeBaseMap[shapeBase]?.[0] || "Blob"}`,
        `Use ${shapeBaseMap[shapeBase]?.[1] || "soft mascot silhouette"} construction.`,
        "Protect silhouette readability before adding details."
      ]);

      phases.splice(Math.min(5, phases.length), 0, [
        `Body build: ${bodyBuildMap[bodyBuild]?.[0] || "Single Soft Blob"}`,
        `Construct using ${bodyBuildMap[bodyBuild]?.[1] || "simple mascot structure"}.`,
        "Keep major forms readable at icon size."
      ]);

      phases.splice(Math.min(6, phases.length), 0, [
        `Backdrop: ${backdropPlan.label} / ${backdropPlan.densityLabel}`,
        `${backdropPlan.instruction} ${backdropPlan.densityRule}`,
...
const skillInfo = skillFocusData[skillFocus] || skillFocusData.shapeControl;
      ...
      renderLesson({
        ...
        backdropStyle,
        backdropDensity,
        backdropName: backdropPlan.label,
        backdropDensityName: backdropPlan.densityLabel,
        ...
        goal: `Draw a ${emo[0].toLowerCase()} ${subject[0].toLowerCase()} using ${subject[1]}, ${emo[1]}, and ${emo[2]}. Use a ${shapeBaseMap[shapeBase]?.[1] || "soft mascot silhouette"} with ${bodyBuildMap[bodyBuild]?.[1] || "simple construction logic"}. Add ${twistSetPhrase} and ${limb.phrase}. Backdrop: ${backdropPlan.label.toLowerCase()} with ${backdropPlan.densityLabel.toLowerCase()} density.${flavorText}${paletteText} Subject lock: stay with ${subject[0].toLowerCase()}; flavor only changes the vibe.`,
        ...
        checks: [
          ...
          "The backdrop supports the mascot without becoming a full scene.",
    ...
    function updateFinalBuildBadge() {
      ...
      if (badge) badge.textContent = `Mascot Spark ${APP_VERSION || "V53"} · Lighting + Shadow Logic Studio · Cache ${APP_CACHE_NAME || "mascot-spark-v54"}`;
    }
