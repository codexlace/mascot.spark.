    ...
    const APP_CACHE_NAME = "mascot-spark-v44";
...
function generalLessonFallback() {
    ...
    function updateFinalBuildBadge() {
      ...
      if (badge) badge.textContent = `Mascot Spark ${APP_VERSION || "V20"} · Tabular Motion + Organized Navigation · Cache ${APP_CACHE_NAME || "mascot-spark-v44"}`;
    }
